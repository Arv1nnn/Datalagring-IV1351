...
INSERT INTO employee (employment_id, department_id, person_id, employee_manager_id, job_id)
VALUES
('EMP01', 1, 1, NULL, 1),
('EMP02', 1, 2, 1, 1),
('EMP03', 2, 3, NULL, 1),
...
INSERT INTO salary_version (salary, employee_id, start_date, end_date)
VALUES
(100000, 1, '2024-01-01', NULL),
(30000,  2, '2024-01-01', NULL),
(78000,  3, '2024-01-01', NULL),
(78000,  4, '2024-01-01', NULL),
(50000,  5, '2024-01-01', NULL),
(69000,  6, '2024-01-01', NULL),
(68000,  7, '2024-01-01', NULL);

UPDATE employee SET salary_version_id = salary_version.id
FROM salary_version
WHERE salary_version.employee_id = employee.id;
...
INSERT INTO course_layout (course_code)
VALUES
('CS101'),
('MATH101'),
('PHYS101'),
...
INSERT INTO course_layout_version (course_name, min_students, max_students, hp, course_layout_id)
VALUES
('Intro to CS', 5, 50, 7.5, 1),
('Intro to CS', 10, 60, 7.5, 1),
('Calculus I', 5, 60, 6.0, 2),
('Calculus I', 8, 70, 7.5, 2),
('Modern physics', 5, 60, 6.0, 3),
('Modern physics', 5, 50, 6.0, 3),
('Complex analysis', 5, 60, 9.5, 4),
('Quantum physics', 10, 100, 7.5, 5),
('Quantum physics', 15, 80, 9.0, 5);


INSERT INTO course_instance (instance_id, num_students, study_period, study_year, course_layout_version_id)
VALUES
('CS101-2025P', 30, 'P1', 2025, 1),
('MATH101-2025P', 40, 'P2', 2025, 3),
('PHYS101-2025P', 50, 'P3', 2025, 5),
('MATH202-2025P', 40, 'P4', 2025, 7),
('PHYS202-2025P', 50, 'P4', 2025, 8),
('CS101-2024P', 25, 'P1', 2024, 2),
('MATH101-2024P', 35, 'P2', 2024, 4),
('PHYS101-2024P', 45, 'P3', 2024, 6),
('MATH202-2024P', 35, 'P4', 2024, 7),
('PHYS202-2024P', 45, 'P4', 2024, 9);



INSERT INTO teaching_activity
(activity_name, preparation_factor, fixed_hours, student_factor, hp_factor)
VALUES
('Lecture', 1.2, 0.0, 1.0, 1.0),
('Lab', 1.5, 0.0, 1.0, 1.0),
('Seminar', 1.1, 0.0, 1.0, 1.0),
('Other', 1.0, 0.0, 1.0, 1.0),
('Tutorial', 1.3, 0.0, 1.0, 1.0),
('Exam', 1.0, 32.0, 0.725, 1.0),
('Admin', 1.0, 28.0, 0.2, 2.0);


INSERT INTO teaching_limit (max_courses_per_teacher_per_period)
VALUES (4);
...
(1, 1, 6, 80), -- Fredrik teaches Lecture CS101           --------- 2024
...
(7, 1, 10, 40), -- Alex teaches Lecture MATH202
(7, 2, 10, 40), -- Alex teaches Lab MATH202
(7, 3, 10, 40), -- Alex Holds seminar MATH202
(7, 4, 10, 40); -- Alex does other activities MATH202