CREATE OR REPLACE VIEW v_teacher_course_workload AS
SELECT
    cl.course_code,
    ci.instance_id,
    cl.hp,
...
JOIN teaching_activity ta ON epa.teaching_act_id = ta.id
...
ORDER BY teacher_name, cl.course_code, ci.instance_id;
